...
// Fade out the loading screen and show menu button and footer images
window.addEventListener('load', function () {
    setTimeout(function () {
        ...
        setTimeout(function () {
            ...
            // Show the menu button and footer images
            document.getElementById('menu-button').style.opacity = '1';
            document.querySelector('.footer-images').style.opacity = '1';
